...
export default function Footer() {
    return <div className="footer">
        ...
        <div className="tecnologias">
            ...
            <img src={html} alt="HTML" className="social-media-photo" />
            <img src={css} alt="CSS" className="social-media-photo" />
            <img src={js} alt="JavaScript" className="social-media-photo" />
        </div>
    </div>
};