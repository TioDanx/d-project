...
function ItemListContainer({titulo}) {
    ...
    let products = [{name:"Tostadora", photo: "https://www.tiomusa.com.ar/imagenes/archivos/2017-02/140-13746-tostadoraoster6544blanco1tm.png", price: 20} ,
    ...
    const itemsPromise = new Promise((res, rej) => {setTimeout(() => {res(products)}, 2000)});
    
    useEffect(() => {itemsPromise.then(itemArray =>{ setItems(itemArray);})}, []);
